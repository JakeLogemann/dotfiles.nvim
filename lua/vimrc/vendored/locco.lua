...
-- package.path = table.concat({ script_path..'/?.lua', package.path }, ';')

-- Load markdown.lua.
local md = require 'vimrc/vendored/markdown'
-- Load Lua Balanced.
local lb = require 'vimrc/vendored/luabalanced'
-- Load HTML templates.
local template = require 'vimrc/vendored/locco_template'
