...
opts.showbreak      = '…'            -- show ellipsis at breaking
...
opts.timeout        = true
opts.timeoutlen     = 500  -- time, in milliseconds, to wait for keymap sequence.
opts.title          = true
opts.titlelen       = 95
opts.titlestring    = "NVIM :: %{expand('%:p:~:.')}%(%m%r%w%)"
opts.ttimeout       = true
opts.ttimeoutlen    = 500 -- time, in milliseconds, to wait for key codes ("<Tab>").
