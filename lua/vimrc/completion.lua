...
function vimrc.fn.setup_completion()
  vimrc.completion = { } -- clear completion's global namespace.
  ...
  vimrc.fn.setup_lsp()
  vimrc.fn.setup_treesitter()
end

function vimrc.fn.setup_lsp()
  -- Lua Language Server --
  local sumneko = {}
  sumneko["root_path"] = vim.env["HOME"]..'/.local/src/github.com/sumneko/lua-language-server'
  sumneko["binary"] = sumneko["root_path"].."/bin/".. vimrc["os_family"] .."/lua-language-server"
...
function vimrc.fn.setup_treesitter()
