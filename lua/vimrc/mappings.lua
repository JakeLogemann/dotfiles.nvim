...
vimp.rbind('nx', opts, {'<leader>ff'}, "<cmd>lua vimrc.plugins.telescope.find_files()<cr>")
vimp.rbind('nx', opts, {'<leader>fh'}, "<cmd>lua vimrc.plugins.telescope.help_tags()<cr>")
vimp.rbind('nx', opts, {'<leader>fr'}, "<cmd>lua vimrc.plugins.telescope.lsp_references()<cr>")
vimp.rbind('nx', opts, {'<leader>fs'}, "<cmd>lua vimrc.plugins.telescope.lsp_workspace_symbols()<cr>")
vimp.rbind('nx', opts, {'<leader>fS'}, "<cmd>lua vimrc.plugins.telescope.lsp_document_symbols()<cr>")
vimp.rbind('nx', opts, {'<leader>fg'}, "<cmd>lua vimrc.plugins.telescope.live_grep()<cr>")
vimp.rbind('nx', opts, {'<leader>fx'}, "<cmd>lua vimrc.plugins.telescope.command_history()<cr>")
vimp.rbind('nx', opts, {'<leader>fb'}, "<cmd>lua vimrc.plugins.telescope.buffers()<cr>")
vimp.rbind('nx', opts, {'<leader>fv'}, "<cmd>lua vimrc.plugins.telescope.open_neovim_config()<cr>")
vimp.rbind('nx', opts, {'<leader>Tn'}, "<cmd>tabNext<cr>")
vimp.rbind('nx', opts, {'<leader>Tp'}, "<cmd>tabprevious<cr>")
vimp.rbind('nx', opts, {'<leader>Tb'}, "<cmd>lua vimr.plugins.libmodal.tab_mode()<cr>")
vimp.rbind('nx', opts, {'<leader>bn'}, "<cmd>bNext<cr>")
vimp.rbind('nx', opts, {'<leader>bp'}, "<cmd>bprevious<cr>")
vimp.rbind('nx', opts, {'<leader>bb'}, "<cmd>lua vimr.plugins.libmodal.buffer_mode()<cr>")
...
vimp.rbind('nx', opts, {'<leader>D'}, "<cmd>lua vimr.diags.new()<cr>")
